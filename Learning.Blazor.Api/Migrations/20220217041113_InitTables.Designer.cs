// <auto-generated />
using System;
using Learning.Blazor.Api.Models;
...
namespace Learning.Blazor.Api.Migrations
{
    ...
    [Migration("20220217041113_InitTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Learning.Blazor.Shared.Country", b =>
                {
            ...
            modelBuilder.Entity("Learning.Blazor.Shared.Employee", b =>
                {
            ...
            modelBuilder.Entity("Learning.Blazor.Shared.JobCategory", b =>
                {
                    b.Property<int>("JobCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Learning.Blazor.Shared.Employee", b =>
                {
                    b.HasOne("Learning.Blazor.Shared.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Learning.Blazor.Shared.JobCategory", "JobCategory")
                        .WithMany()
